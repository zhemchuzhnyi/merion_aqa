...
public class Task2 {
    public static void main(String[] args) {
        ...
        System.out.println("Цвет Zip Code: " + page.getZipCodeResult());
        System.out.println("Цвет Email: " + page.getEmailResult());
        System.out.println("Цвет Phone: " + page.getPhoneResult());
